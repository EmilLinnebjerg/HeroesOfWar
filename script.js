...
class missle{
    constructor(dmg, distance, isPlayers, isInAir, startX, startY){
        this.dmg = dmg;
        ...
        this.projectile.src = "3c242eb786d1eae1ac53ed1713794e30--sci-fi-fantasy-fantasy-world.jpg";
        this.projectile.width = 16;
        this.projectile.height = 16;
        this.projectile.style.left = startX;
        this.projectile.style.top = startY;
                    ...
                    if (queuedDMG.length > 0) {
                        if (queuedDMG[queuedDMG.length - 1].isPlayers && queuedDMG[queuedDMG.length - 1].dealer == this.index) {
                            if(this.range == 0){
                                ...
                                Missles[0] = new missle(this.dmg, this.range, this.BelongsToPlayer, true, this.npc.style.left, this.npc.style.top);
                            }
                        }
                    }
                    if(this.isWalking){
